...
//----------------------------------------------------------------------------------------------------------------------  
  ...
  if(mouseX >15 && mouseX < width-20 && mouseY > 20 && mouseY < height-310){     // \u041e\u0442\u0440\u0438\u0441\u043e\u0432\u0443\u0435\u043c \u043a\u0443\u0440\u0441\u043e\u0440\u043d\u0443\u044e \u043b\u0438\u043d\u0438\u044e \u0438 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u044f \u0438\u0437\u043c\u0435\u0440\u0435\u043d\u0438\u0439
    ...
    if(inf_status == true){
      ...
      text(nf(tmp_ch1[PApplet.parseInt(map(mouseX-15,0,968,0,grBuf))],2,1)+" \u00B0C",  pvx+shx,  pvy+shy*0);
      fill(sColor_ch2);
      text(nf(sen_ch2[PApplet.parseInt(map(mouseX-15,0,968,0,grBuf))],1,2)+" ppm"      ,  pvx,      pvy+shy*1);
      text(nf(tmp_ch2[PApplet.parseInt(map(mouseX-15,0,968,0,grBuf))],2,1)+" \u00B0C",  pvx+shx,  pvy+shy*1);
      fill(sColor_ch3);
      text(nf(sen_ch3[PApplet.parseInt(map(mouseX-15,0,968,0,grBuf))],1,2)+" ppm"      ,  pvx,      pvy+shy*2);
      text(nf(tmp_ch3[PApplet.parseInt(map(mouseX-15,0,968,0,grBuf))],2,1)+" \u00B0C",  pvx+shx,  pvy+shy*2);
      fill(sColor_ch4);
      text(nf(sen_ch4[PApplet.parseInt(map(mouseX-15,0,968,0,grBuf))],1,2)+" ppm"      ,  pvx,      pvy+shy*3);
      text(nf(tmp_ch4[PApplet.parseInt(map(mouseX-15,0,968,0,grBuf))],2,1)+" \u00B0C",  pvx+shx,  pvy+shy*3);
      fill(sColor_ch5);
      text(nf(sen_ch5[PApplet.parseInt(map(mouseX-15,0,968,0,grBuf))],1,2)+" ppm"      ,  pvx,      pvy+shy*4);
      text(nf(tmp_ch5[PApplet.parseInt(map(mouseX-15,0,968,0,grBuf))],2,1)+" \u00B0C",  pvx+shx,  pvy+shy*4);
      fill(255,75);
      text(nf(temperb[PApplet.parseInt(map(mouseX-15,0,968,0,grBuf))],2,1)+" \u00B0C",  pvx+shx,  pvy+shy*5);
      text("R: "+table.getRowCount(),  pvx,  pvy+shy*5);
      
      fill(255,200);
      textFont(font2);
      textAlign(CENTER);
      text(time[PApplet.parseInt(map(mouseX-15,0,968,0,grBuf))],  width/2,45);
    }
  }else{
   if(inf_status == true){
      textFont(font2);
